...
export default function ContactSection() {
  ...
  return (
    <section id="contato" className="scroll-mt-32 pt-16 border-t border-gn-surface pb-32">
      ...
      <div className="max-w-2xl mx-auto flex flex-col items-center gap-10">
        ...
        <div className="w-full flex flex-col items-center gap-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-8 text-sm font-mono text-gn-text w-full">
            <a href="#" className="flex items-center gap-2 hover:text-gn-highlight transition-colors">
            ...
            <div className="hidden sm:block w-px h-4 bg-gn-surface"></div>
            <a href="mailto:samuelandrademedeiros@gmail.com" className="flex items-center gap-2 hover:text-gn-highlight transition-colors">
              <Mail size={18} /> samuelandrademedeiros@gmail.com
            </a>
          </div>
        </div>
